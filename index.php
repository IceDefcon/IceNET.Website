...
<html lang="en-UK">
	...
	<h1>Data Acquisition System for 25kW Microwave Oven</h1>
	<br>
	</div>
	...
	<div class="container">
	  <div class="btn-group btn-group-justified" role="group" aria-label="...">
	    ...
	    <div class="btn-group" role="group">
	      ...
	      <ul class="dropdown-menu dropdown-menu-right dropdown-menu-wide">
	        <li><a type="button" onclick="loadXMLDoc()" href="interferance.php">Phase 1</a>
	        </li>
	        <li><a href="under.php">Phase 2</a>
	        </li>
	        <li><a href="under.php">Phase 3</a>
...
<div class="container">
    ...
    <br><br>
    <h1>MEng 4th Year Group Project</h1>
    <hr>
    <h2>Marek Funtowicz</h2>
    <h2>Joseph Pinchbeck</h2>
    <h2>Smeet Doshi</h2>
    <hr>
</div>
