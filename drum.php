	  ...
	  <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
	    ...
	    <div class="carousel-inner" role="listbox">
	      <div class="item active">
        	<embed src="https://www.youtube.com/embed/watch?v=k7EpIRvabik&list=RDk7EpIRvabik&start_radio=1" width="1200px" height="800px" text-align: center>
	      </div>

	      <div class="item">
	        <embed src="https://www.youtube.com/embed/watch?v=rw6oxwOOTNM&list=PLAFA884C3B5DC349D&index=3" width="1200px" height="800px" text-align: center>
	      </div>
	    </div>
